...
static void Googlesignin_getBinding(const FunctionCallbackInfo<Value>& args)
{
	...
	titanium::bindings::BindEntry *extBinding = titanium::bindings::GooglesigninBindings::lookupGeneratedInit(
...
static void Googlesignin_dispose(Isolate* isolate)
{
	...
	for (uint32_t i = 0; i < length; ++i) {
		...
		titanium::bindings::BindEntry *extBinding =
			titanium::bindings::GooglesigninBindings::lookupGeneratedInit(*binding, bindingLength);
	...
	(JNIEnv *env, jobject self)
{
	...
	titanium::KrollBindings::addExternalLookup(&(titanium::bindings::GooglesigninBindings::lookupGeneratedInit));
}
